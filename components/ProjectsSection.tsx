      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[var(--space-md)]">
        {projects.map((project, index) => (
          <AnimateOnScroll key={project.id} delay={index * 100}>
            <article className="group bg-[var(--color-surface)] border border-[var(--color-border)] rounded-xl p-[var(--space-lg)] flex flex-col hover-lift hover:border-[var(--color-accent)]/30">
              {/* Project visual placeholder */}
              <div className="aspect-video bg-[var(--color-bg)] border border-[var(--color-border)] rounded-lg mb-[var(--space-md)] flex items-center justify-center">
