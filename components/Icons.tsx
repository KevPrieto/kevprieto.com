...
export function AboutIcon({ size = 20, className, ...props }: IconProps) {
  return (
    <svg
      {...defaultStrokeProps}
      width={size}
...
export function ContactIcon({ size = 20, className, ...props }: IconProps) {
  return (
    <svg
      {...defaultStrokeProps}
      width={size}
...
// ============================================================
// THEME TOGGLE ICONS (stroke-based)
// ============================================================
...
// ============================================================
// LOGO ICON (stroke-based)
// ============================================================

export function LogoIcon({ size = 20, className, ...props }: IconProps) {
  return (
    <svg
      {...defaultStrokeProps}
      width={size}
